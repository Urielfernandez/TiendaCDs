    ...
    <section class="container">
      ...
      <div class="row">
        <ul class="col-12 p-0 resumen">
          ...
          <c:forEach var="articulo" items="${carrito.articulos}">
            <li class="producto p-0 py-1">
              <ul class="row p-0">
                <li class="col-2 p-0"><img src="./imagenes/productos/${articulo.imagen}" class="img-fluid" width="175" height="100"></li>
                <li class="col-3 my-auto">${articulo.nombre}</li>
